...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    val editableState = rememberEditableTextInpuState(hint = "Choose Destination")
    ...
    LaunchedEffect(editableState) {
        snapshotFlow { editableState.text }
            .filter {
                !editableState.isHint
            }.collect {
